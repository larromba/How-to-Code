...
- [How to Code](#how-to-code)
  - [The Missing Link: Code, Computer \& Output](#the-missing-link-code-computer--output)
    ...
    - [How does a programming language become 0s and 1s?](#how-does-a-programming-language-become-0s-and-1s)
      ...
      - [Execution by the CPU:](#execution-by-the-cpu)
    - [What are these 0s and 1s?](#what-are-these-0s-and-1s)
      - [Binary Representation:](#binary-representation)
      - [Combination of Bits:](#combination-of-bits)
      - [Bytes:](#bytes)
    ...
    - [If text editors and IDEs are like programs that make programs, how were the very first ones developed?](#if-text-editors-and-ides-are-like-programs-that-make-programs-how-were-the-very-first-ones-developed)
      ...
      - [Assembly Language Concept:](#assembly-language-concept)
    ...
    - [Prior to IDEs, how did people enter code into a computer?](#prior-to-ides-how-did-people-enter-code-into-a-computer)
      ...
      - [Front Panel Entry:](#front-panel-entry)
      - [Plugboards:](#plugboards)
      - [Handwritten Entry:](#handwritten-entry)
    - [Further reading](#further-reading)
  - [History of computing](#history-of-computing)
      - [Ancient Calculating Devices (Pre-1600s):](#ancient-calculating-devices-pre-1600s)
      - [Mechanical Calculators (1600s-1800s):](#mechanical-calculators-1600s-1800s)
      - [Ada Lovelace and the First Programmer (1840s):](#ada-lovelace-and-the-first-programmer-1840s)
      - [Telegraph and Punched Cards (Late 1800s):](#telegraph-and-punched-cards-late-1800s)
      - [Electromechanical Computers (1930s-1940s):](#electromechanical-computers-1930s-1940s)
      - [ENIAC and UNIVAC (1940s-1950s):](#eniac-and-univac-1940s-1950s)
      - [Transistors and Integrated Circuits (1950s-1960s):](#transistors-and-integrated-circuits-1950s-1960s)
      - [Microprocessors and Personal Computers (1970s):](#microprocessors-and-personal-computers-1970s)
      - [Graphical User Interfaces and the Internet (1980s-1990s):](#graphical-user-interfaces-and-the-internet-1980s-1990s)
      - [Mobile Computing and Cloud Technology (2000s-Present):](#mobile-computing-and-cloud-technology-2000s-present)
  ...
  - [Fundamentals of programming](#fundamentals-of-programming)
    - [What are the differences between compiled and interpreted languages?](#what-are-the-differences-between-compiled-and-interpreted-languages)
      ...
      - [Advantages and Disadvantages:](#advantages-and-disadvantages)
        - [Compiled Languages:](#compiled-languages-1)
        - [Interpreted Languages:](#interpreted-languages-1)
    - [What are the differences between functional and procedural programming?](#what-are-the-differences-between-functional-and-procedural-programming)
      - [Functional Programming:](#functional-programming)
        - [Focus on Functions:](#focus-on-functions)
        - [Immutable Data:](#immutable-data)
        - [Avoidance of Side Effects:](#avoidance-of-side-effects)
        - [Declarative Style:](#declarative-style)
        - [Recursion:](#recursion)
        - [Examples:](#examples-2)
      - [Procedural Programming:](#procedural-programming)
        - [Focus on Procedures (Functions):](#focus-on-procedures-functions)
        - [Mutable Data:](#mutable-data)
        - [Use of Side Effects:](#use-of-side-effects)
    ...
    - [What are data types?](#what-are-data-types)
      ...
      - [List:](#list)
      - [Set:](#set)
      - [Dictionary (or Map):](#dictionary-or-map)
      - [Object (Class):](#object-class)
      - [Function:](#function)
      - [Null (or None):](#null-or-none)
      - [Pointer:](#pointer)
    - [What is the stack and the heap?](#what-is-the-stack-and-the-heap)
      ...
      - [Programming Language Impact:](#programming-language-impact)
        - [C and C++:](#c-and-c)
        - [Java, C#, and Python:](#java-c-and-python)
    - [What is a function?](#what-is-a-function)
      - [Name:](#name)
      - [Parameters (or Arguments):](#parameters-or-arguments)
      - [Return Value:](#return-value)
      - [Function Body:](#function-body)
      - [Invocation (Call):](#invocation-call)
      - [Scope:](#scope)
    ...
    - [What are variables?](#what-are-variables)
      ...
      - [Use in Expressions:](#use-in-expressions)
    ...
    - [What is compilation?](#what-is-compilation)
      ...
      - [Compilation Process:](#compilation-process-1)
      - [Lexer (or Scanner):](#lexer-or-scanner)
      - [Parser:](#parser)
      - [Semantic Analysis:](#semantic-analysis)
      - [Intermediate Code Generation:](#intermediate-code-generation)
      - [Optimisation:](#optimisation)
      - [Code Generation:](#code-generation)
      - [Linking (Optional):](#linking-optional)
      - [Executable Output:](#executable-output)
  ...
  - [Becoming a programmer](#becoming-a-programmer)
    ...
    - [What does it take to be a programmer?](#what-does-it-take-to-be-a-programmer)
      ...
      - [Understand Software Development Lifecycle:](#understand-software-development-lifecycle)
      - [Collaboration and Communication Skills:](#collaboration-and-communication-skills)
      - [Stay Curious and Keep Learning:](#stay-curious-and-keep-learning)
    ...
    - [How can freelancing give you more freedom to work on other things?](#how-can-freelancing-give-you-more-freedom-to-work-on-other-things)
      ...
      - [Choose Your Projects:](#choose-your-projects)
      - [Remote Work:](#remote-work)
      - [Diversify Income Streams:](#diversify-income-streams)
      - [Part-Time Freelancing:](#part-time-freelancing)
      - [Personal Projects:](#personal-projects)
      - [Control Over Work Environment:](#control-over-work-environment)
    ...
    - [How to become a freelancer?](#how-to-become-a-freelancer)
      - [1. Identify Your Skills and Niche:](#1-identify-your-skills-and-niche)
      - [2. Build a Portfolio:](#2-build-a-portfolio)
      - [3. Set Up Your Freelance Business:](#3-set-up-your-freelance-business)
      - [4. Determine Your Rates:](#4-determine-your-rates)
      - [5. Use Freelance Platforms:](#5-use-freelance-platforms)
      - [6. Network and Market Yourself:](#6-network-and-market-yourself)
      - [7. Create a Winning Proposal:](#7-create-a-winning-proposal)
      - [Deliver High-Quality Work:](#deliver-high-quality-work)
      - [Request Testimonials:](#request-testimonials)
